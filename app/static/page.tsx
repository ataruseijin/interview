...
export default function StaticPage() {
  ...
  const ANSWERS: Record<string, string> = {
    ...
    q3: `【貴社へ興味を持っている点】<br>
    まず、私の過去の経験を最大に活かせる業務内容であることに、非常に魅力を感じています。<br>
    前職はカスタマーサポートのマネジメントや改善の推進において17年間取り組んできました。その中で、単一のチャネルではなく、電話・メール・チャット・FAQサイト・SNSなど、多様なチャネルを使ったサポートを経験してきました。それに加えて、SaaS系CRM導入の業務も経験しているため、貴社のさらなる事業拡大に貢献できると確信しています。<br>
    また、貴社のプロダクトが国産CRMであることにも魅力を感じています。これまで、ZendeskやOracle、Salesforceなどの海外製CRMを取り扱ってきましたが、カスタマーサポート業務を通じて国産CRMの利用拡大に取り組んでいくことにやりがいを感じます。
    `
  };
